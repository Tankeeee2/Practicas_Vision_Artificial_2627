                             ...
                             std::vector<cv::Point> &min_loc, std::vector<cv::Point> &max_loc)
{
    ...
    CV_Assert(input.channels() == static_cast<int>(min_v.size()));
    CV_Assert(input.channels() == static_cast<int>(max_v.size()));
    CV_Assert(input.channels() == static_cast<int>(min_loc.size()));
    CV_Assert(input.channels() == static_cast<int>(max_loc.size()));
}
